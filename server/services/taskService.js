...
const createTask = async ({ title, project_id, status, creator_id, priority, due_date, description }) => {
  ...
  return await Task.create({ title, project_id, status, creator_id, priority, due_date, description });
};
